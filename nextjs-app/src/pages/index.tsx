...
export default function Home ( { restaurants }: any ) {
  ...
  return (
    <div className={`grid grid-flow-row ${ inter.className }`}>
      <section className="">
        {/* <div className="relative p-6 md:p-24 hidden">
        ...
        <div className="container px-3 mx-auto gap-5 grid justify-center">
          ...
          <div className="flex flex-col items-center w-full p-2">
            ...
            {/* </p> */}
            <h1 className="my-4 text-4xl font-bold flex md:flex-row flex-col items-center">
              <span>最適な方法で</span>
              <span>ホームページを</span>
              <span>作成します。</span>
            </h1>
