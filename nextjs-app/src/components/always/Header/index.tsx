...
// 
  ...
  return (
    <div className="fixed flex flex-row items-start justify-between overflow-visible opacity-80 border-gray-200 px-[8vw] mx-auto w-full dark:bg-black bg-white h-14 z-40">
