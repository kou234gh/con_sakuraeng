const Estimate = ()=>{
  return(
    <div className="container mx-auto px-2 pt-4 pb-12">
          ...
          <h3 className='w-full my-2 text-4xl font-bold leading-tight text-center '>(デモ版無料)</h3>
          <div className="w-full mb-4">
            <div className="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
          </div>
          <div className="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4 bg-white text-gray-800">
